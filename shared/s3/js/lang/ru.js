...
window._s3Lang['GOOGLE_KEY_ERROR'] = "Отсутствует ключ для Google карты в системных настройках. <br>Инструкция по установке: <a href=\"http:///kak-poluchit-api-klyuch-google\">http:///kak-poluchit-api-klyuch-google</a>";
...
window._s3Lang['JS_CHANGE_EDITOR'] = "Рекомендуется сменить версию текстового редактора на <a target=\"_blank\" href=\"http:///smena-versii-tekstovogo-redaktora\">CkEditor</a>";
...
window._s3Lang['S3_VK_ID_MODAL_TEXT'] = "Вам подключен инструмент авторизации VK ID. Вы можете отказаться от использования данной функциональности в настройках пользователей. Продолжение использования инструмента VK ID означает ваше согласие и принятие Оферты об использовании VK ID, опубликованной по адресу: <a href=https:///about/business/go/legal/vkid/offer target=\"_blank\">https:///about/business/go/legal/vkid/offer</a><p></p>Если вы не хотите использовать VK ID, вы всегда можете отключить его в настройках пользователей.";
