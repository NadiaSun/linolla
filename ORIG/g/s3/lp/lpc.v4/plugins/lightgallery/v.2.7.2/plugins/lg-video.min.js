...
this.settings.youTubePlayerParams),a=isYouTubeNoCookie(a),f='<iframe allow="autoplay" id='+c+' class="lpc-lg-video-object lpc-lg-youtube '+b+'" '+h+' src="'+(a?"//www.youtube-nocookie.com/":"///")+"embed/"+(g.youtube[1]+f)+'" allowtransparency="true"\n            frameborder="0"\n            scrolling="no"\n            allowfullscreen\n            mozallowfullscreen\n            webkitallowfullscreen\n            oallowfullscreen\n            msallowfullscreen></iframe>';else if(g.vimeo)c=
...
d.prototype.gotoNextSlideOnVideoEnd=function(a,b){var c=this;a=this.core.getSlideItem(b).find(".lpc-lg-video-object").first();b=this.core.galleryItems[b].__slideVideoInfo||{};if(this.settings.gotoNextSlideOnVideoEnd)if(b.html5)a.on("ended",function(){c.core.goToNextSlide()});else if(b.vimeo)try{(new Vimeo.Player(a.get())).on("ended",function(){c.core.goToNextSlide()})}catch(e){console.error("lightGallery:- Make sure you have included ///vimeo/player.js")}else if(b.wistia)try{window._wq=
...
"*")}catch(e){console.error("lightGallery:- "+e)}else if(a.vimeo)try{(new Vimeo.Player(c.get()))[b]()}catch(e){console.error("lightGallery:- Make sure you have included ///vimeo/player.js")}else if(a.html5)if(this.settings.videojs)try{videojs(c.get())[b]()}catch(e){console.error("lightGallery:- Make sure you have included videojs")}else c.get()[b]();else if(a.wistia)try{window._wq=window._wq||[],window._wq.push({id:c.attr("id"),onReady:function(e){e[b]()}})}catch(e){console.error("lightGallery:- Make sure you have included //fast.wistia.com/assets/external/E-v1.js")}};
